...
3. HQ_CORRECTIONS ampliado (HPE, CVX) y SEDES_HISTORICAS ampliado (SIVB, FRC,
   APC, CXO, TWTR, SBNY, etc.) para reducir caida a Neutral de delistados.

CAMBIOS v11.3 sobre v11.2:
1. Level del indice = cumulative product de retornos equal-weight (base 1000).
2. diagnostico_kurtosis() para outliers.
"""
...
def main(start_date=None, end_date=None, no_cache=False):
    ...
    if "^SP500TR" not in df_close.columns:
        logger.error("Falta ^SP500TR (S&P 500 Total Return)"); return 1
    ...
    print(f"\n  {'METRICA':<28} {'WEST':>14} {'S&P500TR':>14} {'QQQ':>14} {'RSP (EW)':>14}")
    print("  " + "-" * 78)
    metrics_rows = [
    ...
    print(f"\n  === MARCADOR ANO A ANO ===")
    print(f"  {'Ano':<6} {'WEST':>10} {'S&P500TR':>10} {'QQQ':>10} {'RSP':>10}  Ganador")
    print("  " + "-" * 60)
